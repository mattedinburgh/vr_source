...
#define			VR_BLEEDOUT_SAVE_STATE						152 // Vengeance: named bleedout/drag state now occupies former SOLDIERTYPE filler bytes
...
#define			SAVE_GAME_VERSION								VR_BLEEDOUT_SAVE_STATE
