...
#define		ADD_DEAD_SOLDIER_PLAYER_AUTORESOLVE_LOOT		0x00000080				// Player-merc-participating autoresolve victory: preserve a reduced share of tactical loot
#define		ADD_DEAD_SOLDIER_NO_LOOT							0x00000100				// Militia-only/non-player autoresolve provenance: corpse only, no enemy loot
