...
enum
{
	...
	// anv: VR - secondary kingpin group in O9
	CIV_QUOTE_GOONS_FORT_FRIENDLY = 78,
	CIV_QUOTE_GOONS_FORT_ENEMIES = 79,
	CIV_QUOTE_MINERS_NOT_FOR_PLAYER_OIL_RIG = 86,
	CIV_QUOTE_MINERS_FOR_PLAYER_OIL_RIG = 87,

	// anv: VR - Tixa guards
	CIV_QUOTE_WARDEN_FRIENDLY = 88,
	CIV_QUOTE_WARDEN_ENEMIES = 89,
