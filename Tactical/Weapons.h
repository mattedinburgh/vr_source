...
extern UINT32 CalcChanceToHitGun(SOLDIERTYPE *pSoldier, INT32 sGridNo, INT16 sAimTime, UINT8 ubAimPos );
...
extern INT32 TotalArmourProtection( SOLDIERTYPE * pTarget, UINT8 ubHitLocation, INT32 iImpact, UINT8 ubAmmoType, BOOLEAN fConsiderFlak = FALSE );
...
UINT8 GetBurstPenalty( SOLDIERTYPE *pSoldier, OBJECTTYPE *pObj, BOOLEAN fProneStance = FALSE );
UINT8 GetAutoPenalty( SOLDIERTYPE *pSoldier, OBJECTTYPE *pObj, BOOLEAN fProneStance = FALSE );
