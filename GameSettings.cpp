...
// Vengeance has no CTHConstants.ini in its shipped VFS stack, so these fallback defaults matter.
// Keep the shooting/ballistics fallbacks aligned with current 1.13 behavior unless VR explicitly overrides them.
void LoadCTHConstants()
{
	...
	gGameCTHConstants.RECOIL_COUNTER_ACCURACY_AUTO_WEAPONS_DIVISOR		= iniReader.ReadFloat("Shooting Mechanism","RECOIL_COUNTER_AUTO_WEAPONS_DIVISOR",4.0, 1.0, 100.0);
