...
typedef struct
{
	...
	// anv: now configurable
	BOOLEAN fSwitchOffAllRadioBattleEnd;
	...
	UINT32	ubLoadscreenStretchMode;	// added by anv, Venegeance Reloaded
...
typedef struct
{
	...
	FLOAT AIM_TOO_CLOSE_THRESHOLD;	// Fraction of ideal scope range where close-range penalty begins.
